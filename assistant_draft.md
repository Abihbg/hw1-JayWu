...
- Generative AI can summarize financial reports and highlight key insights
- It can help analyze large datasets more efficiently
- It can support decision-making by generating recommendations based on data

---

Prompt used:
Create content for a file called assistant_draft.md. Include a short title, one short paragraph introducing me, one short paragraph describing an industry, function, or problem area I care about, and a short bullet list of 3 ways generative AI might be useful in that area. Keep it simple, clear, and concise.
